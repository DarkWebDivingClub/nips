...
```jsonc
{
    ...
    "result": {
            ...
            "methods": ["pay_invoice", "get_balance", "make_invoice", "lookup_invoice", "list_invoices", "list_transactions", "get_info", "estimate_onchain_fees", "estimate_routing_fees", "pay_offer", "make_offer", "lookup_offer", "list_offers", "disable_offer", "make_new_address", "lookup_address", "list_addresses", "pay_bip321", "make_bip321", "subscribe_notifications"], // list of supported methods for this connection
...
- `pay_invoice`, `pay_offer`, `pay_keysend`, `pay_bip321` → `payment_sent` (useful when the operation is deferred)
...
```jsonc
{
  ...
  "content": "pay_invoice pay_keysend get_balance get_info estimate_onchain_fees estimate_routing_fees make_invoice lookup_invoice list_invoices list_transactions pay_offer make_offer lookup_offer list_offers disable_offer make_new_address lookup_address list_addresses pay_bip321 make_bip321 subscribe_notifications notifications",
